<html>
	<body> 
		...
		<div style="background: DodgerBlue ; border-radius: 5px 5px; padding: 15px;"><span style="font-family: verdana,arial; color: white; font-size: 1.00em; font-weight:bold;">Registration Successful</span></div>
...
<tr><td colspan=2>Not a member yet? Click <a href="http://localhost:8080/Dynamo_DB_Web/Registration.jsp">here</a> to register.</td></tr>
</table>
</form>
</div></div></div>
</body>
