<!--The front end code was referred from http://ns1.authpro.com/cgi-bin/authcode.cgi?user=deluxe-->
...
<html>
	<body> 
		...
		<form method="post" action="http://localhost:8080/Dynamo_DB_Web/SimpleServlet" name="aform" target="_top">
			...
			<tr><td>&nbsp;</td><td><input type="submit" value="Submit" name="loginButton"></td></tr>
